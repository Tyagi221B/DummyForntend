...
const LatestLookbook = () => {
  ...
  const handleBrowseClick = () => {
    navigate("/shop"); // Navigate to the /shop page when the button is clicked
  };
  ...
  return (
    <div>
      ...
      <div className="relative text-center mb-10  items-center flex justify-center">
        ...
        />
        <div className='className="w-[100%] absolute   bottom-[10%] p-4 left-1/2 transform -translate-x-1/2'>
          {/* Updated CustomButton with onClick handler */}
          <CustomButton onClick={handleBrowseClick}>Browse all component</CustomButton>
        </div>
      </div>
    </div>
  );
        ...
        {productImages.map((image, index) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-center text-xs mb-10 lg:text-base mt-2">
                {imageNames[index]}
              </p>
            </motion.div>
          );
