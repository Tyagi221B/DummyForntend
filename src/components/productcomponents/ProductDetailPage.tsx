...
//           <button
//             onClick={prevImage}
//             className="absolute left-0 top-[45%]  px-4 transform -translate-y-1/2 bg-white bg-opacity-50 p-2 rounded-full"
//           >
//             &lt;
//           </button>
//           <button
//             onClick={nextImage}
//             className="absolute right-0 top-[45%]  px-4 transform -translate-y-1/2 bg-gray-300 bg-opacity-50 p-2 rounded-full"
//           >
//             &gt;
//           </button>
...
//           </div>
//           <div className="mb-4">
//             <span className="font-semibold">Size:</span> Height - {product.size.height}mm Width - {product.size.width}mm Length - {product.size.length}mm
//           </div>
//           <div className="mb-4">
...
const ProductDetailPage: React.FC = () => {
  ...
  if (!product) {
    return <div className=' text-center items-center flex justify-center uppercase'>Product not found please click on 1st product which is shown earlier , beacuse we have only one product that is listed right now
