...
//   const [step, setStep] = useState<"choice" | "login" | "signup" | "otp" | "success">("choice");
...
//                   </h2>
//                   <p className="mb-4">
//                     OTP Sent to Mobile No.: {formData.mobile}
//                   </p>
...
//                 >
//                   <h2 className="text-2xl font-semibold mb-4">
//                     {formData.fullName ? `Welcome, ${formData.fullName}!` : "Congratulations!"}
//                   </h2>
//                   <p>
//                     {step === "signup" ? "You have successfully created your account." : "You have successfully logged in."}
//                   </p>
//                   <button
...
//                     {formData.fullName ? `Welcome, ${formData.fullName}!` : "Congratulations!"}
//                   </h2>
//                   <p>{step === "signup" ? "You have successfully created your account." : "You have successfully logged in."}</p>
//                   <button
//                     onClick={handleCongratsClose}
//                     className="mt-4 bg-blue-500 text-white py-2 px-4 rounded-md"
//                   >
