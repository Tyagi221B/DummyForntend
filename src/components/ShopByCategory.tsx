...
const ShopByCategory: React.FC = () => {
  ...
  // Handle category click to navigate to /shop
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
        {categories.map((category, index) => (
          <motion.div
            key={index}
            ref={ref}
            className="text-center cursor-pointer" // Added cursor-pointer for better UX
            ...
            onClick={handleCategoryClick} // Added onClick handler
          >
