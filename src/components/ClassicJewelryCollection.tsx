    ...
    <div className="flex flex-col md:flex-row justify-between items-stretch md:p-12 min-h-full">
      ...
      >
        ...
        <div className="flex-grow">
          ...
          <a
            onClick={handleDiscoverMoreClick} // Added onClick to navigate to /shop
            className="text-gray-700 underline text-sm font-sans tracking-widest hover:text-gray-900 cursor-pointer"
          >
            Discover More
          </a>
        </div>
      ...
      >
        <div className="p-4 flex flex-col justify-stretch items-center text-center rounded-lg">
          ...
          <CustomButton
            ...
            onClick={handleDiscoverMoreClick} // Added onClick to CustomButton
          >
            Discover More
          </CustomButton>
        </div>
